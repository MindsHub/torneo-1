...
fn main() {
    ...
    register_crate!(alessio_1, alessio_2, leo_2, mattiaz_2, mattiaz_1, leo_1, bot_1, bot_2, davide, zen, fabio);
    //calcolo classifica
    let scoreboard=runner::run_turnament(&da_valutare, 1_000_000);
